...
NPC_INTRINSIC_MODIFIER_MAP = {
    ...
    'MODIFIER_VALUE_BULLET_ARMOR_DAMAGE_RESIST': 'IntrinsicBulletArmor',
    'MODIFIER_VALUE_TECH_ARMOR_DAMAGE_RESIST': 'IntrinsicTechArmor',
    'MODIFIER_VALUE_MELEE_DAMAGE_INCREASE_PERCENT': 'IntrinsicMeleeDamageIncrease',
}
