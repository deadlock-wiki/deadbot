...
from resources.ability import ability_parser as abilities
from resources.attribute import attribute_parser as attributes
from resources.changelog import changelog_parser as changelogs
