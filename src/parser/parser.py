...
class Parser:
    def __init__(self):
        ...
        self.abilities_data_path = os.path.join(
            self.data_dir, "scripts/abilities.vdata"
        )
    ...
    def run(self):
        ...
        descriptions = json.read(
            "decompiled-data/localizations/citadel_mods_english.json"
        )
